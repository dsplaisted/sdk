...
namespace Microsoft.TemplateEngine.Cli.UnitTests.ParserTests
{
    ...
    public class TemplateCommandTests
    {
        ...
        public async Task Constraints_WhenTheTemplateIsAllowed()
        {
            ...
            Assert.Empty(await TemplateCommand.ValidateConstraintsAsync(templateConstraintManager, template, default).ConfigureAwait(true));
        }
        ...
        public async Task Constraints_WhenTheTemplateIsRestricted()
        {
            ...
            Assert.NotEmpty(await TemplateCommand.ValidateConstraintsAsync(templateConstraintManager, template, default).ConfigureAwait(true));
        }
