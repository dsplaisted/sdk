...
namespace Microsoft.NET.Sdk.WorkloadManifestReader
{
    public partial class SdkDirectoryWorkloadManifestProvider : IWorkloadManifestProvider
    {
        ...
        public void RefreshWorkloadManifests()
        {
            ...
            bool shouldUseWorkloadSet = true;
            ...
            if (_workloadSet is null)
            {
                ...
                shouldUseWorkloadSet = installState.UseWorkloadSets ?? true;
            }

            if (shouldUseWorkloadSet && _workloadSet == null && availableWorkloadSets.Any())
            {
